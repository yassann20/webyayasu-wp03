                    ...
                    <div class="portofolio-img-slider">
                        ...
                        <div class="portofolio-img-pc">
                            ...
                            <img class="portofolio-img-outer"
                                src="<?php if ($portofolio_pc_img) {
                                            echo esc_url($portofolio_pc_img);
                                        } ?>" alt="">
                            <div class="portofolio-img-content-outer">
                                ...
                                <img class="portofolio-img_inner"
                                    src="<?php if ($portofolio_pc_img_inner) {
                                                echo esc_url($portofolio_pc_img_inner);
                                            } ?>" alt="">
                            </div>
                        </div>
                        <!--portofolio-img-sp-->
                        <div class="portofolio-img-sp">
                            ...
                            <img class="portofolio-img-outer"
                                src="<?php if ($portofolio_sp_img) {
                                            echo esc_url($portofolio_sp_img);
                                        } ?>" alt="">
                            <div class="portofolio-img-content-outer">
                                <?php $portofolio_sp_img_inner = CFS()->get('portofolio_sp_img_inner'); ?>
                                <img class="portofolio-img_inner"
                                    src="<?php if ($portofolio_sp_img_inner) {
                                                echo esc_url($portofolio_sp_img_inner);
                                            } ?>" alt="">
                            </div>
                        </div>
                    </div>
